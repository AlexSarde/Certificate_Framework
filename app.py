...
class CertificateApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.txt_maturity = QLineEdit("756")
        ...
        self.txt_paths = QLineEdit("20000")
    ...
    def load_config(self):
        ...
        try:
            ...
            self.txt_maturity.setText(state.get("maturity", "756"))
            ...
            self.txt_paths.setText(state.get("paths", "20000"))
